  ...
  return (
    <div className="landing flex flex-row justify-center items-center min-h-screen lg:justify-start bg-[#F2F2F2]">
      ...
      <div className="landing-role flex flex-col items-center lg:ml-[70px] lg:items-start">
        ...
        <input type="text" placeholder="Input your Username" className="pl-[10px] px-[20px] py-[10px] rounded-xl w-[300px] lg:w-[400px]" />
        <input type="password" placeholder="Input your Password" className="pl-[10px] px-[20px] py-[10px] rounded-xl w-[300px] lg:w-[400px] mt-[20px]" />
